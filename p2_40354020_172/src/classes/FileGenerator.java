...
public class FileGenerator {
	...
	private int t;    // number of data generators (telephone companies in p1_4035_4020_172
	private int s;    // number of data sets produced per data generator
	 ...
	 * @param totalSize
	 */
	public FileGenerator(int t, int s) {
		this.t = t; 
		this.s = s;
		...
		// final elements are chosen from...
		 // to be used while generating sizes
